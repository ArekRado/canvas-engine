...
type MouseInteractionCheck = (params: {
  state: State
  entity: Entity
}) => boolean

type IsClicked = (params: { isMouseOver: boolean; mouse: Mouse }) => boolean
export const isClicked: IsClicked = ({ mouse, isMouseOver }) =>
  isMouseOver && mouse.buttons !== 0
